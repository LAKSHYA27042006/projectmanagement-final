...
const preLoginQA = {
  en: [
    { q: "Can you tell me about yourself?", a: "I'm the ProjectFlow Assistant! I'm here to help answer your questions about our project management platform. I can tell you about features, pricing, how to get started, and more. Feel free to ask me anything!" },
    { q: "What can you help me with?", a: "I can help you with information about ProjectFlow - our features, pricing plans, how to sign up, security, integrations, and general questions about project management. Just ask away!" },
    { q: "How does this chatbot work?", a: "I'm designed to answer your questions about ProjectFlow. You can type your question or select from the suggested questions. I'll do my best to provide helpful information!" },
  ...
  ta: [
    { q: "உங்களை பற்றி சொல்ல முடியுமா?", a: "நான் ProjectFlow உதவியாளர்! எங்கள் திட்ட மேலாண்மை தளம் பற்றிய உங்கள் கேள்விகளுக்கு பதிலளிக்க இங்கே இருக்கிறேன். அம்சங்கள், விலை, தொடங்குவது எப்படி என்பது பற்றி சொல்ல முடியும். எதையும் கேளுங்கள்!" },
    { q: "நீங்கள் எனக்கு எவ்வாறு உதவ முடியும்?", a: "ProjectFlow பற்றிய தகவல்களுடன் உங்களுக்கு உதவ முடியும் - எங்கள் அம்சங்கள், விலை திட்டங்கள், பதிவு செய்வது எப்படி, பாதுகாப்பு, ஒருங்கிணைப்புகள் மற்றும் பொதுவான கேள்விகள். கேளுங்கள்!" },
    { q: "இந்த சாட்பாட் எப்படி வேலை செய்கிறது?", a: "ProjectFlow பற்றிய உங்கள் கேள்விகளுக்கு பதிலளிக்க நான் வடிவமைக்கப்பட்டுள்ளேன். உங்கள் கேள்வியை தட்டச்சு செய்யலாம் அல்லது பரிந்துரைக்கப்பட்ட கேள்விகளிலிருந்து தேர்ந்தெடுக்கலாம்!" },
    ...
    { q: "நான் எப்படி பதிவு செய்வது?", a: "முகப்புப் பக்கத்தில் 'இலவசமாக தொடங்கு' பொத்தானைக் கிளிக் செய்து, ��ங்கள் விவரங்களை உள்ளிடவும்!" },
    { q: "ProjectFlow மொபைலில் வேலை செய்யுமா?", a: "ஆம், ProjectFlow முழுமையாக பதிலளிக்கக்கூடியது மற்றும் மொபைல், டேப்லெட், டெஸ்க்டாப்பில் நன்றா�� வேலை செய்கிறது." },
  ...
  hi: [
    { q: "क्या आप अपने बारे में बता सकते हैं?", a: "मैं ProjectFlow सहायक हूं! हमारे प्रोजेक्ट प्रबंधन प्लेटफॉर्म के बारे में आपके सवालों के जवाब देने के लिए यहां हूं। मैं फीचर्स, प्राइसिंग, शुरू कैसे करें, और भी बहुत कुछ बता सकता हूं। कुछ भी पूछें!" },
    { q: "आप मेरी कैसे मदद कर सकते हैं?", a: "मैं ProjectFlow के बारे में जानकारी दे सकता हूं - हमारे फीचर्स, प्राइसिंग प्लान्स, साइन अप कैसे करें, सिक्योरिटी, इंटीग्रेशन, और सामान्य सवाल। बस पूछिए!" },
    { q: "यह चैटबॉट कैसे काम करता है?", a: "मैं ProjectFlow के बारे में आपके सवालों के जवाब देने के लिए डिज़ाइन किया गया हूं। आप अपना सवाल टाइप कर सकते हैं या सुझाए गए सवालों में से चुन सकते हैं!" },
...
const postLoginQA = {
  ...
  ta: [
    ...
    { q: "பணியை எப்படி சேர்ப்பது?", a: "எந்த திட்டத்திற்கும் செல்லவும், 'பணி சேர்' பொத்தானைக் கிள��க் செய்து, பெயர், ஒதுக்கப்பட்டவர், நிலுவை தேதி உள்ளிடவும்." },
